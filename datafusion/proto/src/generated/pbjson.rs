...
impl serde::Serialize for GraceHashJoinExecNode {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("datafusion.GraceHashJoinExecNode", len)?;
        if let Some(v) = self.left.as_ref() {
            struct_ser.serialize_field("left", v)?;
        }
        if let Some(v) = self.right.as_ref() {
...
impl<'de> serde::Deserialize<'de> for GraceHashJoinExecNode {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GraceHashJoinExecNode;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct datafusion.GraceHashJoinExecNode")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GraceHashJoinExecNode, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut left__ = None;
        ...
        deserializer.deserialize_struct("datafusion.GraceHashJoinExecNode", FIELDS, GeneratedVisitor)
    }
}
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.logical_plan_type.as_ref() {
            match v {
                ...
                logical_plan_node::LogicalPlanType::Pivot(v) => {
...
;
                        ...
                        GeneratedField::Pivot => {
                            ...
                            logical_plan_type__ = map_.next_value::<::std::option::Option<_>>()?.map(logical_plan_node::LogicalPlanType::Pivot)
;
                        }
                    }
                }
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.physical_plan_type.as_ref() {
            match v {
                ...
                physical_plan_node::PhysicalPlanType::GraceHashJoin(v) => {
                    struct_ser.serialize_field("graceHashJoin", v)?;
                }
            }
        }
        struct_ser.end()
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "graceHashJoin" | "grace_hash_join" => Ok(GeneratedField::GraceHashJoin),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
...
;
                        ...
                        GeneratedField::GraceHashJoin => {
                            if physical_plan_type__.is_some() {
                                return Err(serde::de::Error::duplicate_field("graceHashJoin"));
                            }
                            physical_plan_type__ = map_.next_value::<::std::option::Option<_>>()?.map(physical_plan_node::PhysicalPlanType::GraceHashJoin)
;
                        }
                    }
                }
...
impl serde::Serialize for PivotNode {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        if !self.pivot_values.is_empty() {
            struct_ser.serialize_field("pivotValues", &self.pivot_values)?;
        }
        if let Some(v) = self.schema.as_ref() {
            struct_ser.serialize_field("schema", v)?;
        }
...
impl<'de> serde::Deserialize<'de> for PivotNode {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = PivotNode;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct datafusion.PivotNode")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<PivotNode, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut input__ = None;
                let mut aggregate_expr__ = None;
                    ...
                    match k {
                        ...
                        GeneratedField::PivotColumn => {
                            if pivot_column__.is_some() {
                                return Err(serde::de::Error::duplicate_field("pivotColumn"));
                            }
                            pivot_column__ = map_.next_value()?;
                        }
                        GeneratedField::PivotValues => {
                            if pivot_values__.is_some() {
                                return Err(serde::de::Error::duplicate_field("pivotValues"));
                            }
                            pivot_values__ = Some(map_.next_value()?);
                        }
                        GeneratedField::Schema => {
                            if schema__.is_some() {
                                return Err(serde::de::Error::duplicate_field("schema"));
        ...
        deserializer.deserialize_struct("datafusion.PivotNode", FIELDS, GeneratedVisitor)
    }
}
